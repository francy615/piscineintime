...
const defaultData = {
  products: {
    ...
    // ZANZARE
    zanzare: [
      { nome: 'Trattamento Perimetrale', desc: 'Trattamento su siepi, alberi e aree perimetrali. Efficace tutta la stagione.', img: '', prezzo: 89.00 },
      { nome: 'Trattamento Adulticida',  desc: 'Eliminazione degli adulti presenti nell\'area. Rapidamente efficace.', img: '', prezzo: 69.00 },
      { nome: 'Trattamento Larvicida',   desc: 'Blocca il ciclo riproduttivo nelle acque stagnanti.', img: '', prezzo: 59.00 },
    ],
...
const DB_VERSION = 2; // Incrementa per forzare l'aggiornamento dei prodotti chimici
